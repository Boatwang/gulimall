package com.atguigu.gulimall.thirdparty.common;
...
public class CallbackServer extends HttpServlet {
    ...
    public Map<String,String> doGet()
        ...
        String accessId = "LTAI5tJWAWV361sb2kLLXLsk";
        String accessKey = "RpgO18Qd66T3t9wOsGPpjS80Zxi5SC";
        // Endpoint以华东1（杭州）为例，其它Region请按实际情况填写。
        String endpoint = "oss-cn-qingdao.aliyuncs.com";
        // 填写Bucket名称，例如examplebucket。
        String bucket = "gulimall-mrwang";
        // 填写Host地址，格式为https://bucketname.endpoint。
        String host = "https://gulimall-mrwang.oss-cn-qingdao.aliyuncs.com";
